...
public class AppUser extends BaseEntity implements UserDetails {
	...
	public Collection<GrantedAuthority> getAuthorities() {
		GrantedAuthority[] rights = roles.toArray(new GrantedAuthority[roles.size() + 2]);
		rights[rights.length - 2] = new GrantedAuthorityImpl("ROLE_PUBLIC");
		rights[rights.length - 1] = new GrantedAuthorityImpl("ROLE_ANONYMOUS");
