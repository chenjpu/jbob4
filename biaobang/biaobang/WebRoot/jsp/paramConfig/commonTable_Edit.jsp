...
<html>
	...
	*{margin:0px; padding:0px; border:1px; font-size:12px;}
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="rightpagetitle">
	  <tr>    
	    <td align="left" valign="bottom" style="padding-bottom:5px;">&nbsp;您的位置：<img src="/images/arrow.gif" />修改</td>
	...
	<br><br><br><br/>
		<form name="MyForm" method="post" action="">
			...
			<div style="width:100%;height:100;overflow:auto; z-index=4;">
				<%
				CachedRowSet rs= (CachedRowSet)request.getAttribute("tableData");
				ResultSetMetaData data= rs.getMetaData();
				rs.next();
				%>
				<input type="hidden" name="<%=data.getColumnName(1) %>" value="<%=rs.getString(1) %>"/>
				...
				<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#BDD3E7">			
			        ...
			        String columnValue = rs.getString(i); 
		          	...
		          	<td><input type="text" name="<%=columnName %>" value="<%=columnValue %>"/></td>
		          	</tr>
		          	<% 
			        }
				   %>
