...
<table width="90%" border="0" align="center" cellspacing="0" cellpadding="0">
  <tr>
    <td><div align="right">
    <input type="button" name="button" id="button" value="提交" onclick="specificationChange(1)" />
    <input type="button" name="button" id="button" value="打印预览" onclick="specificationChange(1)" />
    <input type="button" name="button" id="button" value="返回" onclick="specificationChange(1)" />
    </div></td>
  </tr>
  <tr>
    <td><div align="center"><u class="STYLE1">提货单</u></div></td>
  </tr>
  <tr>
    <td><div align="right">日期：2011-1-1</div></td>
  </tr>
  <tr>
