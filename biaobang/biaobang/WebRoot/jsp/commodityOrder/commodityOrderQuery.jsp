...
<html>
	...
	<script type="text/javascript">
		...
		function pjInfoAdd(){
			...
			document.all.addIframe.src="trackOrderAdd.jsp";
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="sreata">
      <tr>
        ...
        <th class="sreabg">分销商</th>
        <td><input id="pjName" name="queryBean.pjName" class="easyui-validatebox" value="${queryBean.pjName}" validType="maxLength[20]" invalidMessage="注：20个汉字以内" required="false" /></td>
        <th class="sreabg">提货日期</th>
        <td>
        ...
        <th class="sreabg">修改时间</th>
        <td>
        <input id="pjItime3" class="easyui-datebox" name="queryBean.pjItime3" value="${queryBean.pjItime1}" size="10" required="false" readonly="true">
        ~
        <input id="pjItime4" class="easyui-datebox" name="queryBean.pjItime4" value="${queryBean.pjItime2}" size="10" required="false" readonly="true">
        </td>
      </tr>
    </table></td>
  </tr>
...
<div style="width:100%;height:280px;overflow:auto;z-index=2;display:;background-color:#fff;">
	...
	<table id="tableData" cellspacing="0" class="listtab" width="100%">
      <tr class="scrollColThead">
		...
		<th class="listtabtit">提货日期</th>
		<th class="listtabtit">经销商</th>
		<th class="listtabtit">分销商</th>
		<th class="listtabtit">级别</th>
		<th class="listtabtit">区域</th>
		<th class="listtabtit">电话</th>
		<th class="listtabtit">传真</th>
		<th class="listtabtit">货运公司</th>
		<th class="listtabtit">电话</th>
		<th class="listtabtit">地址</th>
		<th class="listtabtit">收货明细</th>
		<th class="listtabtit">金额/元</th>
		<th class="listtabtit">操作员</th>
		<th class="listtabtit">修改时间</th>
		<th class="listtabtit">状态</th>
      ...
      <tr onmouseout="listout(this)" onmouseover="listover(this)">
        ...
        <td>王秋妮</td>
        <td>2011-12-1</td>
        <td><font style="color:red;">送审</font></td>
        <td nowrap><a href="commodityOrderEdit.jsp">修改</a> | <a href="#">删除</a></td>
	  </tr>
	  <tr onmouseout="listout(this)" onmouseover="listover(this)">
    	<td align="center"><span class="listtabtit">
        <input type="checkbox" id="pjInfoId" name="pjInfoId" value="''">
        ...
        <td>王秋妮</td>
        <td>2011-12-1</td>
        <td><font style="color:green;">已审</font></td>
        <td nowrap><a href="commodityOrderPrint.jsp">查看</a> | <a href="#">删除</a></td>
		</tr>
	</table>
