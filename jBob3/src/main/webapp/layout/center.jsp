...
<div id="tab-tools" style="border-left: 0">
	<a href="javascript:void(0)" onclick="func_tab_refresh()" class="easyui-linkbutton" data-options="iconCls:'icon-reload',plain:true"></a>
	<!-- a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true,disabled:true"></a-->
</div>
