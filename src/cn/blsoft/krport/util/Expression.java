...
import cn.blsoft.krport.exception.ExpressionException;

public class Expression {
  public static String OPTS = "+-*/%><][!|&=#";
  public static Object calculate(String expression)  throws ExpressionException{
  ...
  protected static int getOptPriorityOut(String opt) throws ExpressionException{
    if (opt.equals("+")) {
      return 1;
    }
    else if (opt.equals("-")) {
  ...
  protected static int getOptPriorityIn(String opt)  throws ExpressionException{
    if (opt.equals("+")) {
      return 3;
    }
    else if (opt.equals("-")) {
  ...
  protected static double calValue(String value1, String opt, String value2)  throws ExpressionException{
    try
    {
  ...
  protected static String getValue(String oldValue)  throws ExpressionException{
  ...
  protected static String calFunction(String function, String rvalue)  throws ExpressionException{
    String lowerFun = function.toLowerCase();
    String value = (String) Expression.calculate(rvalue);
    double db = 0;
    try
    {
