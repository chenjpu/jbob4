  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="sreata">
      <tr>
        ...
        <th class="sreabg">订单客户</th>
        <td><input id="pjName" name="queryBean.pjName" class="easyui-validatebox" value="${queryBean.pjName}" validType="maxLength[20]" invalidMessage="注：20个汉字以内" required="false" /></td>
        <th class="sreabg">下单时间</th>
        <td>
...
<div style="width:100%;height:280px;overflow:auto;z-index=2;display:;background-color:#fff;">
	...
	<table id="tableData" cellspacing="0" class="listtab" width="100%">
      <tr class="scrollColThead">
		...
		<th class="listtabtit">货号</th>
		<th class="listtabtit">订单客户</th>
		<th class="listtabtit">价格</th>
		<th class="listtabtit">数量</th>
		<th class="listtabtit">下单日期</th>
		<th class="listtabtit">完成时间</th>
		<th class="listtabtit">出货时间</th>
		<th class="listtabtit">到纱时间</th>
		<th class="listtabtit">到轴时间</th>
		<th class="listtabtit">是否上机</th>
		<th class="listtabtit">是否已派板</th>
		<th class="listtabtit">价格是否浮动</th>
		<th class="listtabtit">是否完单</th>
