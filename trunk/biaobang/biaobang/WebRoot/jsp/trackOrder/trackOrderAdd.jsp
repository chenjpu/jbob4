  ...
  <tr>
    ...
    <br/>
	    <table width="100%">
	      ...
	      <tr>
	      	<td align="right">出货时间：</td>
	        <td><input id="pjItime" class="easyui-datebox" name="bean.pjItime"  required="true" readonly="true"></input></td>
	        <td align="right">到纱时间：</td>
	        <td><input id="pjItime" class="easyui-datebox" name="bean.pjItime"  required="true" readonly="true"></input></td>
	       
	      </tr>
	      <tr>
	      	<td align="right">到轴时间：</td>
	        <td><input id="pjItime" class="easyui-datebox" name="bean.pjItime"  required="true" readonly="true"></input></td>
	       
	        <td align="right">是否上机：</td>
	      ...
	      <tr>
	        <td align="right">是否已派板：</td>
	        <td><select id="pjManager" class="easyui-combobox" name="bean.pjManager" required="true">
	        <option>是</option>
	        <option>否</option>
	        </select></td>
	        <td align="right">价格是否浮动：</td>
	        <td><select id="pjManager" class="easyui-combobox" name="bean.pjManager" required="true">
	        <option>是</option>
	        <option>否</option>
	        </select></td>
