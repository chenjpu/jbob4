...
<html>
	...
	<script type="text/javascript">
		...
		function pjInfoAdd(){
			...
			document.all.addIframe.src="inventoryAdd.jsp";
...
<div style="width:100%;height:280px;overflow:auto;z-index=2;display:;background-color:#fff;">
	...
	<table id="tableData" cellspacing="0" class="listtab" width="100%">
      <tr class="scrollColThead">
		...
		<th class="listtabtit">布号</th>
		<th class="listtabtit">安重</th>
		<th class="listtabtit">布封/缩率</th>
		<th class="listtabtit">浆纱颜色</th>
		<th class="listtabtit">成份+组织+规格</th>
		<th class="listtabtit">库存</th>
		<th class="listtabtit">坯布</th>
		<th class="listtabtit">在织机台</th>
		<th class="listtabtit">是否有订单</th>
		<th class="listtabtit">存轴码数</th>
		<th class="listtabtit">单价</th>
		<th class="listtabtit">单价是否浮动</th>
		<th class="listtabtit">下单人</th>
		<th class="listtabtit">是否派板</th>
		<th class="listtabtit">是否有板</th>
		<th class="listtabtit">在后整厂数量和后整方法</th>
