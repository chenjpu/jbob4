...
<html>
	...
	<script type="text/javascript">
		...
		function pjInfoAdd(){
			...
			document.all.addIframe.src="produceVarietyLogAdd.jsp";
...
<div style="width:100%;height:280px;overflow:auto;z-index=2;display:;background-color:#fff;">
	...
	<table id="tableData" cellspacing="0" class="listtab" width="100%">
      <tr class="scrollColThead">
		...
		<th class="listtabtit">缸号</th>
		<th class="listtabtit">台数</th>
		<th class="listtabtit">码长</th>
		<th class="listtabtit">头份</th>
		<th class="listtabtit">筘号</th>
		<th class="listtabtit">纬密</th>
		<th class="listtabtit">组织</th>
		<th class="listtabtit">纬纱</th>
		<th class="listtabtit">机台号</th>
		<th class="listtabtit">存轴</th>
		<th class="listtabtit">备注</th>
