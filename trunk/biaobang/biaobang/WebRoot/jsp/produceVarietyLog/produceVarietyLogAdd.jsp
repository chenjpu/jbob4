  ...
  <tr>
    ...
    <br/>
	    <table width="100%">
	      ...
	      <tr>
	        <td align="right">缸号：</td>
	        <td><input type="text"/></td>
	        <td align="right">台数：</td>
	        <td><input type="text"/></td>
	      </tr>
	      <tr>
	        <td align="right">码长：</td>
	        <td><input type="text"/></td>
	        <td align="right">头份：</td>
	        <td><input type="text"/></td>
	        
	      </tr>
	      <tr>
	        <td align="right">筘号：</td>
	        <td><input type="text"/></td>
	        <td align="right">纬密：</td>
	        <td><input type="text"/></td>
	      ...
	      <tr>
	        ...
	        <td><input type="text"/></td>
	        <td align="right">纬纱：</td>
	        <td><input type="text"/></td>
	        
	      </tr>
	      <tr>
	        <td align="right">机台号：</td>
	        <td><input type="text"/></td>
	        <td align="right">存轴：</td>
	        <td><input type="text"/></td>
