				...
				items:[{
					...
					store : new Ext.data.SimpleStore({
								fields : ['flagStyle', 'flagName',
										'flagClass'],
								data : [['ux-flag-blue', '日常计划', 'ux-flag-blue'],
										['ux-flag-orange', '重要计划', 'ux-flag-orange'],
										['ux-flag-green', '特殊计划', 'ux-flag-green'],
										['ux-flag-pink','个人计划','ux-flag-pink'],
										['ux-flag-red','紧急计划','ux-flag-red'],
										['ux-flag-purple','部门计划','ux-flag-purple'],
										['ux-flag-yellow','待定计划','ux-flag-yellow']]
							}),
