		 ...
		 columns:[new Ext.grid.RowNumberer(),{
	      	...
	      	renderer:function(value,metadata,record,rowIndex,colIndex){
	      		...
	      		if(assignee==''){
	      			...
	      			str+='<button title="审核任务" class="btn-approvalTask" onclick="MyTaskView.nextStep(\''+exeId+'\',\''
	      			+activityName+'\')"></button>';
	      			
	      			str+='&nbsp;<button title="任务代办" class="btn-changeTask" onclick="MyTaskView.changeTask('+taskId+',\''+activityName+'\')"></button>';
