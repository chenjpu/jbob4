function CalConv() {
	...
	//alert('year:' + today.getYear());
	var year=today.getYear();
	if(year<2000){
		year+=1900;
	}
	document.getElementById("nowTime").innerHTML = " 当前时间：" + year
			+ "年" + (today.getMonth() + 1) + "月" + today.getDate()
			+ "日&nbsp;&nbsp;" + d[today.getDay() + 1] + "&nbsp;&nbsp;农历"
			+ months[LunarMonth - 1] + "月" + days[LunarDate - 1] + "&nbsp";
