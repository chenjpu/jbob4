	...
	if (this.carId != null && this.carId != 'undefined') {
		formPanel.getForm().load({
			...
			success : function(form, action) {
				...
				Ext.getCmp('buyInsureTime').setValue(new Date(getDateFromFormat(buyInsureTime, "yyyy-MM-dd H:mm:ss")));
				Ext.getCmp('auditTime').setValue(new Date(getDateFromFormat(auditTime, "yyyy-MM-dd H:mm:ss")));
				Ext.getCmp('buyDate').setValue(new Date(getDateFromFormat(buyDate, "yyyy-MM-dd H:mm:ss")));
